...
class helper {
 public:
  helper() = default;
  helper(std::string const &prog) : prog_(prog) {}

  virtual void help() const {
    std::cout << "Usage: " + prog_ + " [OPTION...] FILE" << std::endl
              << "Usage: " + prog_ + " [-h|--help]" << std::endl
              << "Usage: " + prog_ + " [-v|--version]" << std::endl
              << std::endl
              ...
              << "  -o, --output       Specify output file, including directory"
              << std::endl
              << "  -d, --directory    Specify output directory (cannot be "
                 "used with -o)"
              << std::endl
              << std::endl
              << "Issues/bugs/questions visit https://github.com/jeaye/stdman"
              << std::endl;
  }
